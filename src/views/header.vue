      ...
      <div class="navbar">
        ...
        <div class="navbar-right-container" style="display: flex;">
          <div class="navbar-menu-container">
            ...
            <span v-show="!login_status" style="color:#f40">{{ this.userName }}</span>
            <a href="javascript:void(0)" class="navbar-link" v-show="login_status" @click="loginModalFlag=true">Login</a>
...
export default {
  ...
  methods: {
    login () {
      if(!this.userPwd.trim() || !this.userName.trim()){
        this.errorTip = true
        return
      }
      let thisT = this
      ...
      axios.post('/api/users/login',{
        ...
        if (res.status === '0') {
          thisT.errorTip = false
          thisT.loginModalFlag = false
          thisT.login_status = false
        }else {
          thisT.errorTip = true
          thisT.loginModalFlag = true
        }
      })
    },
    logout () {
